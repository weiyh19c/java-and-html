...
public class EarthQuakeClient {
    ...
    public void quakesByPhrase() {
        ...
        //String city = "Can";
        //String filter = "any";
        //String city = "Explosion";
        //String filter = "start";
        //String city = "Creek";
        //String filter = "any";
        String city = "Can";
        String filter = "any";
        ArrayList<QuakeEntry> byPhrase = filterByPhrase(list, filter, city);
        for (QuakeEntry qe : byPhrase) {
            System.out.println(qe);
        }
        System.out.println("Found " + byPhrase.size() + 
                    " quakes that match " + city + " at " + filter);
    }
}
